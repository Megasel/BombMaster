...
namespace FIMSpace.FOptimizing
{
    public abstract partial class Optimizer_Base
    {
        ...
        public float GetMaxDistance { get { if (OptimizersManager.Instance.GlobalMaxDistanceMultiplier == 1f) return MaxDistance; else return MaxDistance * OptimizersManager.Instance.GlobalMaxDistanceMultiplier; } }
